...
# ChatLog = Text(base, bd=0, bg="Yellow", height="10", width="60", font="Verdana",)
...
# scrollbar.place(x=500,y=6, height=440)
# ChatLog.place(x=128,y=100, height=386, width=370)
# EntryBox.place(x=128, y=6, height=90, width=265)
# SendButton.place(x=40, y=6, height=90)
...
pubtop = "publisher@shivam"
subtop = "subscriber@shivam"
FLAG = True
